title: MFSA 2010-07: Fixes for potentially exploitable crashes ported to the legacy branch

<p>
<span class="label">Title:</span>      Fixes for potentially exploitable crashes ported to the legacy branch<br/>
...
<br/>
<span class="label">Fixed in:</span>   Thunderbird 2.0.0.24<br/>
<span class="label"/>            SeaMonkey 1.1.19<br/>
</p>
