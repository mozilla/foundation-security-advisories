title: MFSA 2008-68: XSS and JavaScript privilege escalation

<h1>Mozilla Foundation Security Advisory 2008-68</h1>

<p>
<span class="label">Title:</span>      XSS and JavaScript privilege escalation<br/>
