title: MFSA 2008-52: Crashes with evidence of memory corruption (rv:1.9.0.4/1.8.1.18)

<h1>Mozilla Foundation Security Advisory 2008-52</h1>

<p>
<span class="label">Title:</span>      Crashes with evidence of memory corruption (rv:1.9.0.4/1.8.1.18)<br/>
