title: MFSA 2009-34: Crashes with evidence of memory corruption (rv:1.9.1/1.9.0.12)

<h1>Mozilla Foundation Security Advisory 2009-34</h1>

<p>
<span class="label">Title:</span>      Crashes with evidence of memory corruption (rv:1.9.1/1.9.0.12)<br/>
